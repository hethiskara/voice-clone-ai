          ...
          <div className="col-span-1 md:col-span-1">
            ...
            >
              ...
              <p className="text-gray-300 mb-4 text-sm">
                Transform your voice with our advanced AI technology. Create natural-sounding voice clones for personal projects and content creation.
              </p>
            </motion.div>
          </div>
            ...
            >
              ...
              <ul className="space-y-2">
                <li className="text-gray-300 flex items-center">
                  ...
                  <span>support@voicecloneai.com</span>
                </li>
                <li className="text-gray-300 flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-indigo-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="border-t border-gray-700 mt-10 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-400">
              © {currentYear} VoiceCloneAI. All rights reserved.
            </p>
